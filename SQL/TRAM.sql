...
(
	TransCategoryID				smallint IDENTITY(1,1)		NOT NULL
		PRIMARY KEY,
...
(
	UnitTypeID				tinyint IDENTITY(1,1)		NOT NULL
		PRIMARY KEY,
...
(
	UnitRateID				smallint IDENTITY(1,1)		NOT NULL
		PRIMARY KEY,
...
(
	AmenityID				smallint IDENTITY(1,1)		NOT NULL
		PRIMARY KEY,
...
--Creating foreign keys (primary keys are already established with table creation)
...
--Bulk inserting data into Shaneen_TRAMS
